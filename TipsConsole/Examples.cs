...
namespace TipsConsole
{
	internal class Examples
	{
		...
		public void Deconstruct()
		{
			...
			Console.WriteLine("Robot Name: " + a);
			Console.WriteLine("Robot HasWheels: " + b);
			Console.WriteLine("Robot SensorCount: " + c);

			Console.WriteLine("Robot Name: " + x);
			Console.WriteLine("Robot HasWheels: " + y);
			Console.ReadLine();
		}
